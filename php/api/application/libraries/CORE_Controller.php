...
class CORE_Controller {
	...
	'fund/getAllFunds','extracter/extract','extracter/stock_extract','fund/getAllPrice','fund/getAllPriceJPMORSO'); // this will indicate the script not to run security check
