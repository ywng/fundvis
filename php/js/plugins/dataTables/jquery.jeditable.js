        ...
        return this.each(function() {
            ...
            $(this)[settings.event](function(e) {
                ...
                if (settings.loadurl) {
                    ...
                    $.ajax({
					   headers : {"Access-Control-Allow-Origin" : "*","X-session-token":localStorage.getItem("X-eBrochure-session-token"),"X-email":localStorage.getItem("X-eBrochure-email"),"X-user-type":localStorage.getItem("X-eBrochure-user-type")},
